    ...
    liElement.innerHTML = `
        ...
        <div class="card-wrap-text">
            <div class="card-wrap-text-left">
                <h4 class="game-name">${card.game}</h4>
...
//     // const paginationListBtn = document.querySelectorAll(".pagination");
...
// overlay.addEventListener("click", handleClickBackground);
